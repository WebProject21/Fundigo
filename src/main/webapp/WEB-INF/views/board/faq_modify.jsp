		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-body">
					<form role = "form" action="/board/faq_modify" method="post">
					...
					<div class="form-group">
						<div class="table-panel">
							...
							<button type = "submit" data-oper = "faq_remove" class="btn btn-danger">삭제</button>
	...
	$(document).ready(function(){
		...
		$('button').on("click", function(e){
			...
			if(operation === 'faq_remove'){
				...
				formObj.attr("action", "/board/"+type).attr("method","get");
